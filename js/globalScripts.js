...
$j('.modulewrap').each(function () {
	//$j('head').append('<link rel="stylesheet" type="text/css" href="https://d2nfzhdjx5k7v7.cloudfront.net/CEFED/_Axis-Website/Sites/SITEDIRECTORYHERE/css/modules.css">');
	$j('head').append('<link rel="stylesheet" type="text/css" href="//clubessential.s3.amazonaws.com/CEFED/_Axis-Website/Sites/SITEDIRECTORYHERE/css/modules.css">');
